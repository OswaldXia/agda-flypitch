...
↥/ : (φ : Formulaₗ l) (s : Term) (n₁ n₂ : ℕ) → (φ ↥ (suc (n₁ + n₂))) [ s / n₁ ] ≡ φ ↥ (n₁ + n₂)
↥/ φ s n₁ n₂ = ↥[]/ φ s (n₁ + n₂) n₁ 0 z≤n (m≤m+n n₁ n₂)

↥[]1/ : (φ : Formulaₗ l) (s : Term) (n : ℕ) → (φ ↥[ n ] 1) [ s / n ] ≡ φ
↥[]1/ φ s n = trans (↥[]/ φ s 0 n n ≤-refl n≤n+0) (↥[]0 φ) where
  n≤n+0 = subst (n ≤_) (sym $ (+-identityʳ n)) ≤-refl

↥1/ : (φ : Formulaₗ l) (s : Term) → (φ ↥ 1) [ s / 0 ] ≡ φ
↥1/ φ s = ↥[]1/ φ s 0
