...
module SyntheticAlt.Definitions.Prophood where
open import SyntheticAlt.PartialFunction
open import SyntheticAlt.Definitions.Base
open import SyntheticAlt.Definitions.DecIso using (DecIsoDecidable)
open import SyntheticAlt.Definitions.DecIso using (isPropDecides) public
